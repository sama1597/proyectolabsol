...
class SubscriptionController extends Controller
{
    ...
    public function admin () {
		...
		return view('subscriptions.admin', compact('proyectos'));
    }
    ...
    public function resume () {
		...
		if ($subscription->cancelled() && $subscription->onGracePeriod()) {
			...
			return back()->with('message', ['success', __("Has reanudado al proyecto  correctamente")]);
		}
		return back();
    }
    ...
    public function cancel () {
	    ...
	    return back()->with('message', ['success', __("Se ha cancelado unirte al proyecto  correctamente")]);
    }
}
